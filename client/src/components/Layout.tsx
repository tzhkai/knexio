...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return <div className="site-shell">
    ...
    <style>{layoutRefinements}</style><main><div className="publication-imprint" aria-hidden="true"><img src="/manus-storage/workflow-library-mark_89833f8a.png" alt="" /><span>W—L / Field record</span></div>{children}</main>

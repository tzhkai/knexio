...
const styles = `
  ...
  @media(max-width:760px) { .priority-plan-template-head { display:grid; gap:13px; }.priority-plan-template h2 { font-size:25px; }.priority-plan-template-actions { grid-template-columns:1fr 1fr; }.priority-plan-template-button { width:100%; }.priority-plan-template p { font-size:12px; } }
`;

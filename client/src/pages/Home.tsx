...
export default function Home() {
  ...
  return <Layout>
    <SeoMeta title="Practical AI workflows for better everyday work" description="A reading-first library of practical AI workflows, prompts, checks, and boundaries for research, writing, meetings, and planning." />
    <section className="hero-section">
      ...
      <div className="hero-visual"><div className="hero-image-frame"><img src={heroImage} alt="A calm desk arranged with research notes, paper, and an understated laptop" /></div><div className="hero-index-card"><span>START HERE</span><strong>Give the task a brief.</strong><p>Context, constraints, output.</p></div><div className="hero-number">01</div></div>
    </section>

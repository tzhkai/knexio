...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    category: "Writing", readingTime: "7 min read", level: "Starter", updated: "4 Sep 2026", publishedAt: "2026-08-14T09:10:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["project update", "AI writing workflow", "status update prompt", "clear communication"],
  ...
  },
  {
    ...
    category: "Planning", readingTime: "9 min read", level: "Deep dive", updated: "4 Sep 2026", publishedAt: "2026-08-14T09:30:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["content plan", "audience questions", "AI content planning", "content workflow"],
  ...
  },
  {
    ...
    category: "Writing", readingTime: "6 min read", level: "Starter", updated: "4 Sep 2026", publishedAt: "2026-08-14T09:40:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["ChatGPT prompts for work", "prompt framework", "AI first draft", "brief-first prompt"],
  ...
  },
  {
    ...
    category: "Planning", readingTime: "7 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-14T09:50:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["project planning", "AI planning workflow", "next steps", "project start"],
  ...
  },
  {
    ...
    category: "Meetings", readingTime: "7 min read", level: "Starter", updated: "4 Sep 2026", publishedAt: "2026-08-14T10:00:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["meeting follow-up email", "meeting notes prompt", "action items", "AI meeting workflow"],
  ...
  },
  {
    ...
    category: "Research", readingTime: "8 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-14T10:10:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["decision log template", "project decision record", "AI research workflow", "decision prompt"],
  ...
  },
  {
    ...
    category: "Planning", readingTime: "8 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-14T10:20:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["weekly priorities", "project planning", "AI task prioritization", "weekly planning prompt"],
  ...
  },
  {
    ...
    category: "Meetings", readingTime: "8 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-15T09:00:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["AI meeting agenda prompt", "meeting agenda from notes", "meeting preparation", "AI meeting workflow"],
  ...
  },
  {
    ...
    category: "Research", readingTime: "10 min read", level: "Deep dive", updated: "4 Sep 2026", publishedAt: "2026-08-15T09:10:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["AI customer feedback analysis", "customer feedback analysis template", "voice of customer", "feedback theme map"],
  ...
  },
  {
    ...
    category: "Planning", readingTime: "9 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-15T09:20:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["project handoff template", "AI project handoff", "project documentation", "handoff checklist"],
  ...
  },
  {
    ...
    category: "Research", readingTime: "10 min read", level: "Deep dive", updated: "4 Sep 2026", publishedAt: "2026-08-16T10:00:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["decision memo template", "project decision memo", "AI decision support", "decision making prompt"],
...
First, separate the notes into evidence, assumptions, options, and unresolved questions. Then draft a memo with: (1) decision question, (2) relevant context, (3) evidence with source labels, (4) options and trade-offs, (5) recommendation only where the evidence supports it, (6) risks and unanswered questions, and (7) the next confirmation needed from the decision owner. Do not invent facts, source links, costs, approvals, owners, or dates. Label any inference as an inference.`,
    ...
    },
  {
    ...
    category: "Writing", readingTime: "8 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-16T11:20:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["AI email prompt", "decision-ready email", "project communication", "email writing workflow"],
...
Use this structure only if the information supports it: context, what changed, options or recommendation, request, and details to confirm. Preserve names, dates, costs, and commitments exactly as supplied. If the notes do not support a recommendation, present the options and write “recommendation not established.” End with one specific response requested from the recipient. List any missing information before the email body.`,
  ...
  },
  {
    ...
    category: "Planning", readingTime: "8 min read", level: "Everyday", updated: "4 Sep 2026", publishedAt: "2026-08-16T11:30:00+08:00", updatedAt: "2026-09-04T09:00:00+08:00", topics: ["weekly review template", "AI weekly planning", "blocked tasks", "productivity review"],
...
/** Page-specific practice notes use the reader's own records; they do not present invented results, personas, testimonials, or customer data. */
export const guidePracticeNotes: Record<string, GuidePracticeNote> = {
  "project-notes-to-decision-memo": { title: "Practice: turn one confirmed question into a decision memo", body: "Use this page when a reader needs to understand a choice, not merely receive a status summary. Begin with one decision question and keep the record behind each important claim visible.", startWith: "A dated note set, the decision owner, the options actually discussed, and source labels for material evidence.", output: "A short memo with separate sections for context, options, evidence, recommendation, unresolved questions, and the decision still required.", avoid: "Do not turn a proposed option into an approved decision or fill missing evidence with plausible-sounding explanation.", verify: "The decision owner should reopen the cited records and confirm that the recommendation, trade-offs, and next action are represented accurately." },
  "turn-rough-notes-into-decision-email": { title: "Practice: write one decision-ready email from rough notes", body: "This is a communication workflow for a known reader and a bounded choice. It is not a shortcut for deciding what the organization should do.", startWith: "The intended recipient, the single decision or response needed, confirmed facts, open questions, and any date or owner explicitly stated.", output: "A concise email that labels context, the choice or response requested, supporting record, open questions, and the deadline only when supplied.", avoid: "Do not imply agreement, urgency, approval, or ownership that the notes do not state.", verify: "Compare every name, date, commitment, and quoted fact with the original note before sending." },
  "clear-project-update-prompt": { title: "Practice: separate progress from the next useful ask", body: "A project update earns trust by making status language precise. The exercise is to show what changed and what remains uncertain without polishing uncertainty away.", startWith: "A one-sentence project context, dated progress notes, known risks, decisions, and the audience's next action.", output: "A reader-ready update with only the sections needed: progress, decision, risk, next step, and one clearly scoped request.", avoid: "Do not use completed, on track, blocked, or approved unless the supplied record supports that exact status.", verify: "Ask the project owner to check status words, people, dates, and the requested action before publication." },
  "brief-first-prompt-pattern": { title: "Practice: make an ambiguous prompt reviewable", body: "The brief-first pattern is most useful before drafting begins. It turns a vague request into a small contract that a person can inspect and correct.", startWith: "The task verb, intended reader, relevant context, non-negotiable constraints, output shape, and information that is still missing.", output: "A first draft plus an explicit list of assumptions, missing inputs, and questions that should be answered before reuse.", avoid: "Do not ask the model to choose hidden priorities or treat an unstated audience, deadline, or definition as fact.", verify: "Read the assumptions separately from the draft and remove any sentence that cannot be supported by the supplied brief." },
  "one-week-content-plan-from-questions": { title: "Practice: plan from questions you can actually inspect", body: "A useful content plan starts with a traceable question rather than a list of popular-sounding topics. Keep the source of each question beside the proposed piece.", startWith: "Real question records, the audience context you can substantiate, available publishing capacity, and the outcome the content should support.", output: "One primary piece, a small number of supporting pieces, the question each addresses, the original input still needed, and a relevant internal link.", avoid: "Do not invent search demand, audience size, conversion results, or a publishing capacity that was not supplied.", verify: "Open the source question for every planned piece and remove any item whose promise cannot be supported by the record." },
  "thirty-minute-project-starting-plan": { title: "Practice: choose a first move with a stop condition", body: "The point of a short starting plan is not to make a project look complete. It is to make the next uncertainty small enough for a person to inspect.", startWith: "A defined outcome, the facts already known, the available half-hour, dependencies, and the uncertainty that blocks a credible first step.", output: "A five-minute setup, one focused action, a checkpoint question, a stop condition, and decisions reserved for a human owner.", avoid: "Do not create a confident sequence that depends on missing access, approvals, deadlines, or technical facts.", verify: "At the stop condition, record what was learned and whether the owner should continue, narrow the task, or ask for missing information." },
  "weekly-priorities-from-project-list": { title: "Practice: make trade-offs visible in a weekly focus", body: "A weekly priority list is a decision aid, not an automated ranking. Its value is in showing what fits, what is blocked, and what will intentionally wait.", startWith: "The week's desired outcome, available people and time, hard dependencies, stated deadlines, and risks that require an owner's judgment.", output: "Must move, useful if capacity remains, blocked or dependent, and not for this week—each with a reason grounded in the supplied list.", avoid: "Do not estimate effort, invent deadlines, or claim that an item is the highest priority without a stated decision rule.", verify: "Have the person who owns the trade-off confirm the final list and the items deliberately left out." },
  "weekly-review-from-completed-and-blocked-work": { title: "Practice: review the record before rewriting the plan", body: "A weekly review should produce a clearer next conversation, not a flattering account of progress. Keep completed, blocked, carried-forward, and stopped work distinct.", startWith: "The previous week's intended outcomes, completed records, blocked items, reasons supplied by the team, and changes in context.", output: "A review of what changed, what remains blocked, what should stop or continue, and the smallest decision or experiment for the next period.", avoid: "Do not infer performance, blame, root cause, or future certainty from an incomplete activity list.", verify: "Ask the owner to confirm the classification of each item and document any explanation that is still unknown." },
  "decision-log-from-project-notes": { title: "Practice: preserve the choice and the reason behind it", body: "A decision log is an accountability record. Use it after a decision question has been discussed, while keeping proposals and confirmed choices separate.", startWith: "The decision question, options mentioned, evidence labels, constraints, the person or group with authority, and any explicit decision statement.", output: "A dated record of the question, options, evidence, decision status, owner, review point, and unresolved questions.", avoid: "Do not backfill a decision from a confident note, assign an owner from context, or hide a trade-off because it makes the record shorter.", verify: "The decision owner should confirm the status and reopen the source notes for every material rationale." },
  "meeting-follow-up-email": { title: "Practice: make the shared record easy to correct", body: "A follow-up email is valuable when it gives participants a short window to correct the record. Treat silence as silence, not confirmation.", startWith: "Confirmed decisions, actions with explicitly stated owners and dates, open questions, and the participants who need to review the record.", output: "A concise follow-up with Decisions, Actions, To confirm, and a correction invitation where needed.", avoid: "Do not manufacture agreement, convert a suggestion into an action, or infer an owner or due date.", verify: "Compare the draft with the notes and make any unconfirmed item visible before sending." },
  "meeting-agenda-from-notes": { title: "Practice: build an agenda from what still needs a conversation", body: "An agenda should narrow attention. It should carry forward open questions and new context without reopening a settled decision without a reason.", startWith: "The previous meeting's confirmed record, open questions, actions, new context, and the outcome needed from the next meeting.", output: "A purpose, three to five discussion or decision items, preparation notes, needed inputs, and items deliberately excluded.", avoid: "Do not assign an outcome, owner, or deadline that was not supplied, and do not treat every old note as agenda material.", verify: "The meeting owner should approve the agenda and check that each item has a clear reason to be discussed now." },
  "customer-feedback-theme-map": { title: "Practice: keep a theme as a hypothesis", body: "Theme mapping is an organizing step, not proof of customer sentiment or market demand. Preserve the original record so a reader can challenge the grouping.", startWith: "Feedback records with source labels and dates, the research question, known sample limits, and groups or channels represented.", output: "Candidate themes, supporting records, counter-examples, direct quotations versus paraphrases, gaps, and questions for the next check.", avoid: "Do not invent counts, sentiment scores, personas, quotes, or conclusions beyond the supplied sample.", verify: "Return to the original records and ask whether another reasonable grouping or missing segment would change the interpretation." },
  "project-handoff-brief": { title: "Practice: make the next owner independent of the summary", body: "A handoff is successful when another person can find the source behind a claim and see which decisions remain open. It should reduce rediscovery without pretending uncertainty is resolved.", startWith: "The project purpose, confirmed status, decisions and source locations, active risks, dependencies, access boundaries, and the next known milestone.", output: "A current objective, confirmed status, decisions with sources, active work, risks, open questions, and a first-week checklist.", avoid: "Do not fabricate permissions, approvals, timelines, stakeholder views, or completion status.", verify: "Ask the next owner to locate the cited records and mark any missing access or context before relying on the handoff." }
};

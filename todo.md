...
- [ ] 复核本地变更、测试结果、GitHub main 祖先关系与本次发布范围
- [ ] 创建 GitHub 备份分支，并将已验证的旗舰内容和 SEO 审计记录同步到独立审阅分支
- [ ] 核验 GitHub 审阅分支的提交、文件范围和与 main 的差异；不改动 Cloudflare 生产部署
- [ ] 保存 GitHub 审阅分支同步记录并交付结果；不提交 AdSense 审核或新的索引请求
